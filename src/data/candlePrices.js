...
const LABEL_PHOTOS = {
  ...
  'atrium-lidded': {
    image: '/assets/images/romazen-atrium-cloche-signature.jpeg',
    imageWidth: 1254,
    galleryImages: [
...
const COLLECTION_DETAILS = {
  ...
  'atrium-lidded': {
    ...
    dimensions: '3½″ H × 3½″ W',
    order: 2,
    size: 'Full-cloche compact form',
    price: 58,
    notes: 'Gardenia · Jasmine',
    details: 'A complete bell-jar glass jacket descends from its round knob to surround and protect the entire inner candle between burns.',
    description: 'A premium full-cloche soy candle with luminous gardenia and soft jasmine notes.',
  },
  'silk-santal-33oz': {
    name: 'The Halo',
